...
set(gcf,'Units','centimeters','position',[1 -0.5 59 2400 ],'Name','DTMF_Main'); % UI Window Position

bip=[100,550]; % button inital position
bs=60; % button inital size

AuthorDisplay=uicontrol('Style', 'text', 'Position',[bip+[0 bs*3],400,35],'String', 'Designed by Abhishek Chunduri','FontSize',20,'HorizontalAlignment','left','BackgroundColor',[0.937 0.867 0.867]);
...
buttonHash = uicontrol; % Generate Button
set(buttonHash,'String','#','Position',[bip+[bs*2 -bs*3],repmat(bs,1,2)],'BackgroundColor',[0.804 0.878 0.969]); % Property
set(buttonHash,'Callback','button_hash'); % button reaction and call function button_hash
